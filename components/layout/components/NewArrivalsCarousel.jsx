    ...
    <section className="py-8 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <button
            ref={prevRef}
            className="hidden md:flex absolute -left-3 lg:-left-5 top-[45%] -translate-y-1/2 z-10 w-10 h-10 lg:w-12 lg:h-12 bg-white rounded-full shadow-lg items-center justify-center hover:bg-gray-50 transition-colors group"
          ...
          <button
            ref={nextRef}
            className="hidden md:flex absolute -right-3 lg:-right-5 top-[45%] -translate-y-1/2 z-10 w-10 h-10 lg:w-12 lg:h-12 bg-white rounded-full shadow-lg items-center justify-center hover:bg-gray-50 transition-colors group"
