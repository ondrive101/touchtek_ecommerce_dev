...
export default function ProductCard({ id, name, image, slug, category }) {
  return (
    <motion.div
    ...
    >
      <div className="aspect-square relative bg-gradient-to-br from-gray-50 to-gray-100 overflow-hidden">
        ...
        <div className="absolute top-3 left-3">
          <div className="bg-gradient-to-r from-gray-800 to-black text-white px-3 py-1 rounded-full text-xs font-semibold flex items-center gap-1">
