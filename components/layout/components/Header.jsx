        ...
        <div className="flex justify-between items-center h-16">
          ...
          <nav className="hidden md:flex space-x-8">
            ...
            <div className="relative group">
              ...
              <div className="absolute left-1/2 transform -translate-x-1/2 mt-2 w-[600px] bg-white shadow-2xl rounded-2xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50 border border-gray-100 backdrop-blur-sm">
                <div className="p-8">
                  {/* Header */}
                  ...
                  <div className="grid grid-cols-2 gap-6 mb-6">
                    ...
                    <div className="group/item bg-gradient-to-br from-gray-50 to-white rounded-xl p-4 hover:shadow-lg transition-all duration-300 border border-gray-100">
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        <Link href="/products?category=Polymer" className="flex items-center gap-2 p-2 rounded-lg hover:bg-gray-100 transition-colors group/link">
                        ...
                        <Link href="/products?category=Lithium" className="flex items-center gap-2 p-2 rounded-lg hover:bg-gray-100 transition-colors group/link">
                          <div className="w-6 h-6 rounded bg-gray-200 overflow-hidden">
                    ...
                    <div className="group/item bg-gradient-to-br from-gray-50 to-white rounded-xl p-4 hover:shadow-lg transition-all duration-300 border border-gray-100">
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        <Link href="/products?category=Earbuds" className="flex items-center gap-2 p-2 rounded-lg hover:bg-gray-100 transition-colors group/link">
                          <div className="w-6 h-6 rounded bg-gray-200 overflow-hidden">
                        ...
                        <Link href="/products?category=Neckbands" className="flex items-center gap-2 p-2 rounded-lg hover:bg-gray-100 transition-colors group/link">
                          <div className="w-6 h-6 rounded bg-gray-200 overflow-hidden">
                        ...
                        <Link href="/products?category=Earphones" className="flex items-center gap-2 p-2 rounded-lg hover:bg-gray-100 transition-colors group/link">
                          <div className="w-6 h-6 rounded bg-gray-200 overflow-hidden">
                            <img src="https://images.unsplash.com/photo-1590658268037-6bf12165a8df?w=50&h=50&fit=crop&contrast=110" alt="Earphones" className="w-full h-full object-cover" />
                          </div>
                          <span className="text-xs text-gray-700 group-hover/link:text-black">Earphones</span>
                        </Link>
                        <Link href="/products?category=Speaker" className="flex items-center gap-2 p-2 rounded-lg hover:bg-gray-100 transition-colors group/link">
                          <div className="w-6 h-6 rounded bg-gray-200 overflow-hidden">
                            <img src="https://images.unsplash.com/photo-1608043152269-423dbba4e7e1?w=50&h=50&fit=crop" alt="Speaker" className="w-full h-full object-cover" />
                          </div>
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    ...
                    <div className="group/item bg-gradient-to-br from-gray-50 to-white rounded-xl p-4 hover:shadow-lg transition-all duration-300 border border-gray-100">
                      ...
                      <div className="grid grid-cols-2 gap-1">
                        <Link href="/products?category=Charger" className="flex items-center gap-2 p-1.5 rounded-lg hover:bg-gray-100 transition-colors group/link">
                          <div className="w-5 h-5 rounded bg-gray-200 overflow-hidden">
                            <img src="https://images.unsplash.com/photo-1585776245991-cf89dd7fc73a?w=40&h=40&fit=crop" alt="Charger" className="w-full h-full object-cover" />
                          </div>
                          <span className="text-xs text-gray-700 group-hover/link:text-black">Charger</span>
                        </Link>
                        <Link href="/products?category=Car Charger" className="flex items-center gap-2 p-1.5 rounded-lg hover:bg-gray-100 transition-colors group/link">
                          <div className="w-5 h-5 rounded bg-gray-200 overflow-hidden">
                        ...
                        <Link href="/products?category=Data Cable" className="flex items-center gap-2 p-1.5 rounded-lg hover:bg-gray-100 transition-colors group/link">
                          <div className="w-5 h-5 rounded bg-gray-200 overflow-hidden">
                            <img src="https://images.unsplash.com/photo-1544947950-fa07a98d237f?w=40&h=40&fit=crop" alt="Data Cable" className="w-full h-full object-cover" />
                          </div>
                          <span className="text-xs text-gray-700 group-hover/link:text-black">Data Cable</span>
                        </Link>
                        <Link href="/products?category=Power Bank" className="flex items-center gap-2 p-1.5 rounded-lg hover:bg-gray-100 transition-colors group/link">
                          <div className="w-5 h-5 rounded bg-gray-200 overflow-hidden">
                            <img src="https://images.unsplash.com/photo-1609081219090-a6d81d3085bf?w=40&h=40&fit=crop" alt="Power Bank" className="w-full h-full object-cover" />
                          </div>
                    ...
                    <div className="group/item bg-gradient-to-br from-gray-50 to-white rounded-xl p-4 hover:shadow-lg transition-all duration-300 border border-gray-100">
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        <Link href="/products?category=Cover" className="flex items-center gap-2 p-2 rounded-lg hover:bg-gray-100 transition-colors group/link">
                          <div className="w-6 h-6 rounded bg-gray-200 overflow-hidden">
                        ...
                        <Link href="/products?category=Tempered Glass" className="flex items-center gap-2 p-2 rounded-lg hover:bg-gray-100 transition-colors group/link">
                          <div className="w-6 h-6 rounded bg-gray-200 overflow-hidden">
                        ...
                        <Link href="/products?category=Combo" className="flex items-center gap-2 p-2 rounded-lg hover:bg-gray-100 transition-colors group/link">
                          <div className="w-6 h-6 rounded bg-gray-200 overflow-hidden">
                            <img src="https://images.unsplash.com/photo-1583394838336-acd977736f90?w=50&h=50&fit=crop&hue=60" alt="Combo" className="w-full h-full object-cover" />
                          </div>
                  ...
                  <div className="mt-6 pt-4 border-t border-gray-100">
                    <Link href="/products" className="block w-full text-center bg-black text-white py-2 px-4 rounded-lg hover:bg-gray-800 transition-colors text-sm font-medium">
                      View All Products
                    </Link>
                  </div>
                </div>
