...
const Attachments = ({
  ...
  const handleFileUpload = (uploadedFile) => {
    ...
    formDataObj.append("type", "comment-image");
    formDataObj.append("folder", "task/comments/images");
    formDataObj.append("resource_type", "image");
    ...
    <>
      <div className="relative">
        <Button
          type="button"
          size="icon"
          className="h-4 w-4 bg-default-100 rounded-full hover:bg-default-200"
          onClick={() => setOpen(true)}
        >
          <Icon icon="heroicons:paper-clip" className="w-4 h-4 text-primary" />
        </Button>
      </div>
