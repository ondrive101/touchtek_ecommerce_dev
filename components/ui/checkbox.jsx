...
const checkboxVariants = cva(
  "peer group  shrink-0   ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled: [&_svg]:stroke-primary-foreground ",
  {
    variants: {
      color: {
        default:
