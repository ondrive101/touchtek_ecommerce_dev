...
Configuring themes in Touchtek is incredibly simple. The primary configuration file is site.js. Inside the site.js file, you can set up your theme, layout, sidebar type, sidebar color, and more. Refer to the code snippet below for all available options.

```js filename="site.js"
export const siteConfig = {
  name: "Touchtek Next js Admin Template",
  description: null,
  theme: "violet",
