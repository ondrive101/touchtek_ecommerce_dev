          ...
          <div className="text-center mb-8">
            ...
            {isSent ? (
              ...
              >
                ...
                <p className="text-sm text-gray-600">We've sent a password reset link to your inbox</p>
              </motion.div>
            ) : (
              <motion.div
                initial={{ opacity: 0, y: 20 }}
            ...
            >
              ...
              <span className="text-xs font-semibold text-gray-700">Secure Reset</span>
          ...
          {isSent ? (
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-4">
                <Link
                  href="/login"
                  className="flex items-center justify-center gap-2 bg-gradient-to-r from-black to-gray-800 text-white py-3 px-6 rounded-lg hover:shadow-xl transition-all font-semibold"
                >
                ...
                <button
                  ...
                  className="flex items-center justify-center gap-2 border-2 border-gray-300 text-gray-700 py-3 px-6 rounded-lg hover:border-black hover:bg-gray-50 transition-all font-semibold"
                >
                  Resend Email
                </button>
              </div>
            ...
            <>
              ...
              <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.7 }} className="text-center text-sm text-gray-600 mt-6">
