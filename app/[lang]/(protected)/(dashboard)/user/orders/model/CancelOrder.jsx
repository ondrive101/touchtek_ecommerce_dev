          ...
          {!done ? (
              ...
              <div className="p-6 space-y-5">
                ...
                <div className="flex items-start gap-3 bg-red-50 border border-red-200 rounded-xl px-4 py-3">
                  ...
                  <p className="text-xs text-red-600 font-medium">
                    Once cancelled, this cannot be undone. Refund (if
                ...
                <div className="bg-gray-50 border border-gray-100 rounded-xl p-4">
                  ...
                  {order.items.map((item, idx) => (
                    <div
                      key={idx}
                      className="flex items-center gap-2 py-1.5 border-t border-gray-100 first:border-0"
                    >
                      <p className="text-xs font-medium text-gray-700 truncate flex-1 capitalize">
                        {item?.name}
                      </p>
                  ...
                  <div className="space-y-2">
                    {cancelReasons.map((r) => (
                      ...
                      >
                        ...
                        />
                        <span
                          className={`text-xs font-medium ${reason === r ? "text-red-700" : "text-gray-700"}`}
                        >
                          {r}
                        </span>
                      </motion.label>
            ...
            >
              ...
              <p className="text-xs text-green-600 font-semibold bg-green-50 border border-green-200 rounded-xl px-4 py-2 inline-block mb-7">
                Refund of ₹{order.total.toLocaleString()} will be credited in
                5–7 business days
              </p>
              <motion.button
