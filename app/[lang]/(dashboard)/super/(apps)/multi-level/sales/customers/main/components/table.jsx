...
import AddEmployee from "./modalContents/add-customer";
import AddEmployeeBulk from "./modalContents/add-customer-bulk";
...
export function BasicDataTable({ list = [], session }) {
  ...
  const columns = [
    {
      accessorKey: "customerSeries",
      header: () => <div className="text-center">#</div>,
      cell: ({ row }) => {
        return (
          <div className="text-center font-medium">
            {row?.original?.customerSeries}
          </div>
        );
      },
    },
    ...
    {
      accessorKey: "referBy",
      header: () => <div className="text-center">Refer By</div>,
      cell: ({ row }) => {
        return (
          <div className="text-center font-medium capitalize">
            {row?.original?.employeeInformed?.referBy === ""
              ? "None"
              : row?.original?.employeeInformed?.referBy}
          </div>
        );
