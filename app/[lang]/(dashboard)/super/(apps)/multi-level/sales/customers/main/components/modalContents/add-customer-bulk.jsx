...
import { addBulkCustomers } from "@/action/superadmin/controller";
 ...
 reader.readAsArrayBuffer(file); // Use readAsArrayBuffer
  ...
  const handleSubmit = async () => {
    try {
      ...
      const response = await addBulkCustomers(excelData, session);
