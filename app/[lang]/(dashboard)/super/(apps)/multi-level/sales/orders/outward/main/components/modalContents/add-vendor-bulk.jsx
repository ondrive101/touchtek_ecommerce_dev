...
import { addBulkSuppliers } from "@/action/superadmin/controller";
...
const AddSupplierBulk = ({ session }) => {
  ...
  const handleSubmit = async () => {
    try {
      ...
      const response = await addBulkSuppliers(excelData, session);
...
export default AddSupplierBulk;
