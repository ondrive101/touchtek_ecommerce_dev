...
const InvoiceStats = ({ product }) => {
  const data = [
    {
      id: 1,
      title: "Total Orders",
      amount: product?.purchaseOrders.length,
      percentage: "3.25",
    ...
    },
    {
      ...
      amount: product?.purchaseOrders.filter(order => order.orderStatus === "completed").length,
      percentage: "8.2",
    ...
    },
    {
      ...
      amount: product?.purchaseOrders.filter(order => order.orderStatus === "in-progress").length,
      percentage: "8.2",
