...
import { addBulkEmployee } from "@/action/superadmin/controller";
 ...
 reader.readAsArrayBuffer(file); // Use readAsArrayBuffer
  ...
  const handleSubmit = async () => {
    try {
      ...
      const response = await addBulkEmployee(excelData, session);
    ...
    <Dialog>
      ...
      {showModal && (
        <DialogContent size="4xl">
            ...
            <DialogDescription className="sr-only">Upload employee data using Excel sheet to create multiple employees at once</DialogDescription>
          <DialogHeader>
