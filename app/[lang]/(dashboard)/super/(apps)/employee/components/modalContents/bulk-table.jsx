...
export function BasicDataTable({ list}) {
  ...
  const columns = [
    ...
    },
    {
        ...
        header: () => <div className="text-center">Employee Code</div>,
        cell: ({ row }) => {
         console.log(row)
          return (
 ...
 
    {
        ...
        cell: ({ row }) => {
         console.log(row)
          return (
            <div className="text-center font-medium">{row?.original?.dateOfBirth}</div>
          );
        },
      },
      {
        accessorKey: "dateOfJoining",
        header: () => <div className="text-center">Date of Joining</div>,
        cell: ({ row }) => {
         console.log(row)
          return (
            <div className="text-center font-medium">{row?.original?.dateOfJoining}</div>
          );
        },
      },
