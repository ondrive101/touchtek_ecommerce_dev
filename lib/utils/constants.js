...
export const PARENT_CATEGORIES = [
  ...
  { _id: "lithium-battery", name: "Lithium Batteries" },
  { _id: "polymer-battery", name: "Polymer Batteries" }
];
...
export const CATEGORIES = {
  accessories: [
    ...
    { _id: "data-cable", name: "Data Cable" },
    ...
    { _id: "microphone", name: "Microphones" },
    { _id: "keyboard", name: "Keyboard" },
    { _id: "mouse", name: "Mouse" },
    { _id: "keyboard & mouse", name: "Keyboard & Mouse" },
  ],
  batteries: [
    { _id: "lithium-battery", name: "Lithium" },
    { _id: "polymer-battery", name: "Polymer" }
  ]
};
...
export const ERROR_CODES = {
  // Checkout Page
  CHECKOUT_FETCH_FAILED: "47854E",
  CHECKOUT_NO_DATA: "47854F",
  CHECKOUT_INVALID_FORM: "478550",

  // User Profile Page  
  PROFILE_LOAD_ERROR: "478600",
  PROFILE_SAVE_FAILED: "478601",

  // Payment Page
  PAYMENT_INIT_ERROR: "478700",
  PAYMENT_TOKEN_INVALID: "478701",

  // Orders Page
  ORDERS_FETCH_FAILED: "478800",
  ORDERS_NO_DATA: "478801",
  ORDERS_LOAD_MORE_FAILED: "478802",
  ORDERS_CANCEL_FAILED: "478803",
  ORDERS_DETAIL_FETCH_FAILED: "478804",
  ORDERS_INVALID_STATUS: "478805",
};
